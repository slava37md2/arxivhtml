<?php
    $rubrika = str_replace('/recent', '', $_GET['r']);//удаляем /recent
    if(!file_exists($rubrika.".html")){//в папке list
        $page = file_get_contents( 'https://export.arxiv.org/list/astro-ph.GA/recent' );echo $page;//https://export.arxiv.org/'.$rubrika.'/recent
        file_put_contents($rubrika.".html", $page);
    }
